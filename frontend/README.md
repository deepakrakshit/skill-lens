This is the SkillLens frontend: a Next.js dashboard for real GitHub profile analysis with no fake demo data.
...
You can start editing the page by modifying `src/app/page.tsx` or `src/app/dashboard/page.tsx`.
